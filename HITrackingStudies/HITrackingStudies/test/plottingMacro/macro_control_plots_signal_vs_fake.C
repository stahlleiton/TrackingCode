///Please, run it by doing: <<root -l -b -q macro_control_plots_signal_vs_fake.C>>
///Usually, depending on the number of events you processed & selections, will be needed to adjust y-axis range
///Run in a MC tree produced by: "HITrackingStudies/HITrackingStudies/test/run_PbPb_cfg.py"

///Auxiliar functions

//Function to select high-purity matched, unmatched and all tracks & saving standard variables
std::vector<float> func_select_trks( ROOT::VecOps::RVec<Float_t> vec_ori, ROOT::VecOps::RVec<Bool_t> vec_trk_fake, ROOT::VecOps::RVec<Bool_t> vec_trk_hp, Int_t option ){
   std::vector<float> v;
...
std::vector<float> func_ratio_select_trks( ROOT::VecOps::RVec<Float_t> vec_num, ROOT::VecOps::RVec<Float_t> vec_den, ROOT::VecOps::RVec<Bool_t> vec_trk_fake, ROOT::VecOps::RVec<Bool_t> vec_trk_hp, Int_t option ){
   std::vector<float> v;
...
std::vector<float> func_chi2_select_trks( ROOT::VecOps::RVec<Float_t> vec_chi2, ROOT::VecOps::RVec<Float_t> vec_ndf,ROOT::VecOps::RVec<Float_t> vec_nlayers, ROOT::VecOps::RVec<Bool_t> vec_trk_fake, ROOT::VecOps::RVec<Bool_t> vec_trk_hp, Int_t option ){
   std::vector<float> v;
...
void macro_control_plots_signal_vs_fake(){
...
auto fileName = "trk_5k_events.root"; //input file
...
auto d_select = d.Filter(cent_cut,"Centrality cut") //filter events only in this centrality range --- see definition above
	         .Define("trkPt_sig","func_select_trks(trkPt.trkPt,trkFake.trkFake,highPurity.highPurity,1)") //pt
	         .Define("trkPt_fak","func_select_trks(trkPt.trkPt,trkFake.trkFake,highPurity.highPurity,2)") //pt
		 .Define("trkPt_all","func_select_trks(trkPt.trkPt,trkFake.trkFake,highPurity.highPurity,3)") //pt 
                 .Define("trkEta_sig","func_select_trks(trkEta.trkEta,trkFake.trkFake,highPurity.highPurity,1)") //eta
                 .Define("trkEta_fak","func_select_trks(trkEta.trkEta,trkFake.trkFake,highPurity.highPurity,2)") //eta
                 .Define("trkEta_all","func_select_trks(trkEta.trkEta,trkFake.trkFake,highPurity.highPurity,3)") //eta 
                 .Define("trkPhi_sig","func_select_trks(trkPhi.trkPhi,trkFake.trkFake,highPurity.highPurity,1)") //phi
                 .Define("trkPhi_fak","func_select_trks(trkPhi.trkPhi,trkFake.trkFake,highPurity.highPurity,2)") //phi
                 .Define("trkPhi_all","func_select_trks(trkPhi.trkPhi,trkFake.trkFake,highPurity.highPurity,3)") //phi 
		 .Define("trkNHit_sig","func_select_trks(trkNHit.trkNHit,trkFake.trkFake,highPurity.highPurity,1)") //nhits
                 .Define("trkNHit_fak","func_select_trks(trkNHit.trkNHit,trkFake.trkFake,highPurity.highPurity,2)") //nhits
                 .Define("trkNHit_all","func_select_trks(trkNHit.trkNHit,trkFake.trkFake,highPurity.highPurity,3)") //nhits
		 .Define("trkDzSig_sig","func_ratio_select_trks(trkDz1.trkDz1,trkDzError1.trkDzError1,trkFake.trkFake,highPurity.highPurity,1)") //dzSig
                 .Define("trkDzSig_fak","func_ratio_select_trks(trkDz1.trkDz1,trkDzError1.trkDzError1,trkFake.trkFake,highPurity.highPurity,2)") //dzSig
                 .Define("trkDzSig_all","func_ratio_select_trks(trkDz1.trkDz1,trkDzError1.trkDzError1,trkFake.trkFake,highPurity.highPurity,3)") //dzSig
	         .Define("trkDxySig_sig","func_ratio_select_trks(trkDxy1.trkDxy1,trkDxyError1.trkDxyError1,trkFake.trkFake,highPurity.highPurity,1)") //dxySig
                 .Define("trkDxySig_fak","func_ratio_select_trks(trkDxy1.trkDxy1,trkDxyError1.trkDxyError1,trkFake.trkFake,highPurity.highPurity,2)") //dxySig
                 .Define("trkDxySig_all","func_ratio_select_trks(trkDxy1.trkDxy1,trkDxyError1.trkDxyError1,trkFake.trkFake,highPurity.highPurity,3)") //dxySig
		 .Define("trkPtRes_sig","func_ratio_select_trks(trkPtError.trkPtError,trkPt.trkPt,trkFake.trkFake,highPurity.highPurity,1)") //ptRes
                 .Define("trkPtRes_fak","func_ratio_select_trks(trkPtError.trkPtError,trkPt.trkPt,trkFake.trkFake,highPurity.highPurity,2)") //ptRes
                 .Define("trkPtRes_all","func_ratio_select_trks(trkPtError.trkPtError,trkPt.trkPt,trkFake.trkFake,highPurity.highPurity,3)") //ptRes
		 .Define("trkChi2_sig","func_chi2_select_trks(trkChi2.trkChi2,trkNdof.trkNdof,trkNlayer.trkNlayer,trkFake.trkFake,highPurity.highPurity,1)") //ptRes
                 .Define("trkChi2_fak","func_chi2_select_trks(trkChi2.trkChi2,trkNdof.trkNdof,trkNlayer.trkNlayer,trkFake.trkFake,highPurity.highPurity,2)") //ptRes
                 .Define("trkChi2_all","func_chi2_select_trks(trkChi2.trkChi2,trkNdof.trkNdof,trkNlayer.trkNlayer,trkFake.trkFake,highPurity.highPurity,3)")//ptRes
...
const unsigned int N_variables = 13; //Sequence: pt, eta, phi, nhits, dzSig, dxySig, ptRes, chi2, nhits_nMinusOne, dzSig_nMinusOne, dxySig_nMinusOne, chi2_nMinusOne, ptRes_nMinusOne...
std::string variable_name_all[N_variables]={"trkPt_all","trkEta_all","trkPhi_all","trkNHit_all","trkDzSig_all","trkDxySig_all","trkPtRes_all","trkChi2_all","trkNHit_NminusOne_all","trkDzSig_NminusOne_all","trkDxySig_NminusOne_all","trkPtRes_NminusOne_all","trkChi2_NminusOne_all"}; //variables' name
std::string variable_name_sig[N_variables]={"trkPt_sig","trkEta_sig","trkPhi_sig","trkNHit_sig","trkDzSig_sig","trkDxySig_sig","trkPtRes_sig","trkChi2_sig","trkNHit_NminusOne_sig","trkDzSig_NminusOne_sig","trkDxySig_NminusOne_sig","trkPtRes_NminusOne_sig","trkChi2_NminusOne_sig"};
std::string variable_name_fak[N_variables]={"trkPt_fak","trkEta_fak","trkPhi_fak","trkNHit_fak","trkDzSig_fak","trkDxySig_fak","trkPtRes_fak","trkChi2_fak","trkNHit_NminusOne_fak","trkDzSig_NminusOne_fak","trkDxySig_NminusOne_fak","trkPtRes_NminusOne_fak","trkChi2_NminusOne_fak"};
TString hist_name_all[N_variables]={"trkPt","trkEta","trkPhi","trkNHit","trkDzSig","trkDxySig","trkPtRes","trkChi2","trkNHit_NminusOne","trkDzSig_NminusOne","trkDxySig_NminusOne","trkPtRes_NminusOne","trkChi2_NminusOne"}; //histograms' name
TString hist_name_sig[N_variables]={"trkPt_sig","trkEta_sig","trkPhi_sig","trkNHit_sig","trkDzSig_sig","trkDxySig_sig","trkPtRes_sig","trkChi2_sig","trkNHit_NminusOne_sig","trkDzSig_NminusOne_sig","trkDxySig_NminusOne_sig","trkPtRes_NminusOne_sig","trkChi2_NminusOne_sig"};
TString hist_name_fak[N_variables]={"trkPt_fak","trkEta_fak","trkPhi_fak","trkNHit_fak","trkDzSig_fak","trkDxySig_fak","trkPtRes_fak","trkChi2_fak","trkNHit_NminusOne_fak","trkDzSig_NminusOne_fak","trkDxySig_NminusOne_fak","trkPtRes_NminusOne_fak","trkChi2_NminusOne_fak"};
TString hist_title_all[N_variables]={"p_{T} of HP tracks","#eta of HP tracks","#phi of HP tracks", "NHits of HP tracks", "DzSig of HP tracks", "DxySig of HP tracks", "Pt Resolution of HP tracks","#chi^{2}/ndf/nlayers of HP tracks","NHits with All Other Cuts","DzSig with All Other Cuts", "DxySig with All Other Cuts","Pt Resolution with All Other Cuts","#chi^{2}/ndf/nlayers with All Other Cuts"}; //histograms' title
...
TString hist_title_fak[N_variables]={"p_{T} of HP unmatched tracks", "#eta of HP unmatched tracks","#phi of HP unmatched tracks", "NHits of HP unmatched tracks","DzSig of HP unmatched tracks", "DxySig of HP unmatched tracks", "Pt Resolution of HP unmatched tracks", "#chi^{2}/ndf/nlayers of HP unmatched tracks", "NHits with All Other Cuts unmatched","DzSig with All Other Cuts unmatched", "DxySig with All Other Cuts unmatched","Pt Resolution with All Other Cuts unmatched","#chi^{2}/ndf/nlayers with All Other Cuts unmatched"};
const float hist_Nbins[N_variables]= {100,100,100,50,100,100,100,100,50,100,100,100,100}; //Number of bins 
const float hist_Xrange_min[N_variables]= {0,-3.5,-4.5,0,-30,-30,0,0,0,-30,-30,0,0}; //Minimum value of the x-axis range
const float hist_Xrange_max[N_variables]= {10,3.5,4.5,50,30,30,0.3,1,50,30,30,0.3,1}; //Maximum value of the x-axis range
TString hist_XaxisTitle[N_variables]={"p_{T} (GeV/c)","#eta","#phi","Number of Hits", "dZ/#sigma_{dZ}", "dXY/#sigma_{dXY}","p_{T}Err/p_{T}","#chi^{2}/ndf/nlayers","Number of Hits","dZ/#sigma_{dZ}", "dXY/#sigma_{dXY}","p_{T}Err/p_{T}","#chi^{2}/ndf/nlayers"}; //Title of x-axis
const float hist_Yrange_min[N_variables]={0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9}; //Minimum of the y-axis range
const float hist_Yrange_max[N_variables]={10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000}; //Maximum of the y-axis
const float histNorm_Yrange_min[N_variables]={0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001,0.00001}; //Minimum of the y-axis range
const float histNorm_Yrange_max[N_variables]={0.15,0.03,0.03,0.30,0.30,0.30,0.30,0.12,0.30,0.30,0.30,0.30,0.15}; //Maximum of the y-axis range 
...
gSystem->Exec("mkdir -p ControlPlots"); //Directory to save the histograms
...
for (unsigned int i=0; i<N_variables; i++){
   ...
   leg_norm->Draw();
   tc.Print("ControlPlots/"+fig_name[i]); //save Canvas in a PDF file...we can change format if needed PNG, JPG, ..etc...
