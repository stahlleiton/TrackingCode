...
std::vector<float> func_NminusOneVar_select_trks( std::vector<float> vec_nHits, std::vector<float> vec_chi2, std::vector<float> vec_dzSig, std::vector<float> vec_dxySig, std::vector<float> vec_ptRes, bool isNhit, bool isChi2, bool isDzSig, bool isDxySig, bool isPtRes ){
   ...
   float cut_ptRes = 0.05; // 0.10 default
   float cut_chi2 = 0.18;
   float cut_nhits = 6; // 11 default
...
void macro_control_plots_signal_vs_fake_MCrecodebugOnly_New(){
...
TString fig_name[N_variables]={"hist_pt_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_eta_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_phi_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_nhits_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_dZsig_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_dXYsig_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_pTres_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_chi2_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_algo_sig_vs_fak_NoSel_pT0p5_nhits6_ptres0p05.pdf","hist_nhits_sig_vs_fak_NimusOneCuts_pT0p5_nhits6_ptres0p05.pdf","hist_dZsig_sig_vs_fak_NimusOneCuts_pT0p5_nhits6_ptres0p05.pdf","hist_dXYsig_sig_vs_fak_NimusOneCuts_pT0p5_nhits6_ptres0p05.pdf","hist_pTres_sig_vs_fak_NimusOneCuts_pT0p5_nhits6_ptres0p05.pdf","hist_chi2_sig_vs_fak_NimusOneCuts_pT0p5_nhits6_ptres0p05.pdf"}; //Name of the figure file with the histograms saved
