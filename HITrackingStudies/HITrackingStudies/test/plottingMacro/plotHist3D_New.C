...
void plotHist3D_New() {
  ...
  //change the centrality bins according to tracking code
  double occBins[11] = {0.0, 20.0, 40.0, 60.0, 80.0, 100.0, 120.0, 140.0, 160.0, 180.0, 200.0};
    
  int occbin010_min = hSim->GetZaxis()->FindBin(occBins[0]+0.1);
  int occbin010_max = hSim->GetZaxis()->FindBin(occBins[1]-0.1);
  int occbin1020_min = hSim->GetZaxis()->FindBin(occBins[1]+0.1);
  int occbin1020_max = hSim->GetZaxis()->FindBin(occBins[2]-0.1);
  int occbin2030_min = hSim->GetZaxis()->FindBin(occBins[2]+0.1);
  int occbin2030_max = hSim->GetZaxis()->FindBin(occBins[3]-0.1);
  int occbin3040_min = hSim->GetZaxis()->FindBin(occBins[3]+0.1);
  int occbin3040_max = hSim->GetZaxis()->FindBin(occBins[4]-0.1);
  int occbin4050_min = hSim->GetZaxis()->FindBin(occBins[4]+0.1);
  int occbin4050_max = hSim->GetZaxis()->FindBin(occBins[5]-0.1);
  int occbin5060_min = hSim->GetZaxis()->FindBin(occBins[5]+0.1);
  int occbin5060_max = hSim->GetZaxis()->FindBin(occBins[6]-0.1);
  int occbin6070_min = hSim->GetZaxis()->FindBin(occBins[6]+0.1);
  int occbin6070_max = hSim->GetZaxis()->FindBin(occBins[7]-0.1);
  int occbin7080_min = hSim->GetZaxis()->FindBin(occBins[7]+0.1);
  int occbin7080_max = hSim->GetZaxis()->FindBin(occBins[8]-0.1);
  int occbin8090_min = hSim->GetZaxis()->FindBin(occBins[8]+0.1);
  int occbin8090_max = hSim->GetZaxis()->FindBin(occBins[9]-0.1);

  cout << "etabin24m: " << etabin24m << " etabin24p: " << etabin24p << endl;
  //cout << "etabin10m: " << etabin24m << " etabin10p: " << etabin24p << endl;
  cout << "ptbin04: " << ptbin04 << " ptbins: " << ptbins << endl;
  //cout << "occbin0: " << occbin0 << "occbin50: " << occbin50 << endl;
  cout<< "occbin010_min: "<<occbin010_min<< "  occbin010_max: "<<occbin010_max<<endl;
  cout<< "occbin1020_min: "<<occbin1020_min<< "  occbin1020_max: "<<occbin1020_max<<endl;
  cout<< "occbin2030_min: "<<occbin2030_min<< "  occbin2030_max: "<<occbin2030_max<<endl;
  cout<< "occbin3040_min: "<<occbin3040_min<< "  occbin3040_max: "<<occbin3040_max<<endl;
  cout<< "occbin4050_min: "<<occbin4050_min<< "  occbin4050_max: "<<occbin4050_max<<endl;
  cout<< "occbin5060_min: "<<occbin5060_min<< "  occbin5060_max: "<<occbin5060_max<<endl;
  cout<< "occbin6070_min: "<<occbin6070_min<< "  occbin6070_max: "<<occbin6070_max<<endl;
  cout<< "occbin7080_min: "<<occbin7080_min<< "  occbin7080_max: "<<occbin7080_max<<endl;
  cout<< "occbin8090_min: "<<occbin8090_min<< "  occbin8090_max: "<<occbin8090_max<<endl;
