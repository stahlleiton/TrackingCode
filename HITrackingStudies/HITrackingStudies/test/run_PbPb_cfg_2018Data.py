...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('2018PbPb_DataMAOD_GeneralTracks.root')
)
...
process.source.lumisToProcess = LumiList.LumiList(filename = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions18/HI/PromptReco/Cert_326381-327564_HI_PromptReco_Collisions18_JS\
ON.txt').getVLuminosityBlockRange()
