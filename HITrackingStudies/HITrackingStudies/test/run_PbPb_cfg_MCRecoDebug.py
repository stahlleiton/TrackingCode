...
process.HITrackCorrections.ptErrMax = 0.1 # default 0.1
process.HITrackCorrections.nhitsMin = 8 # default 11
...
if (options.sample == "MC_MiniAOD" or options.sample == "MC_RecoDebug"):
